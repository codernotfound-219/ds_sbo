...
use super::{find_cost_inserting_in_batch, find_cost_creating_before, find_cost_creating_after};
...
pub fn make_decision(schedule: &BatchSchedule, batch_index: usize, job: &Job) -> Decision {
    ...
    let cost_inserting_in = find_cost_inserting_in_batch(schedule, batch_index, job, i32::MAX);
